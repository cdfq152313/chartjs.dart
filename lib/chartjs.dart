...
import 'dart:html'
    show CanvasRenderingContext2D, CanvasElement, Event, UIEvent, MouseEvent;
...
abstract class ChartHoverOptions {
  ...
  external bool get intersect;
  external set intersect(bool v);
  external void onHover(UIEvent event, List activeElements);
  external factory ChartHoverOptions(
      {String mode,
      num animationDuration,
      bool intersect,
      void Function(UIEvent event, List activeElements) onHover});
}
...
class ChartAnimationOptions {
  ...
  external factory ChartAnimationOptions({num duration,
    String easing,
    void Function(dynamic chart) onProgress,
    void Function(dynamic chart) onComplete});
}
